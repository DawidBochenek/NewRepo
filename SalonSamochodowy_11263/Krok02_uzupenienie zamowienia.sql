...
DECLARE @startLoop2ID INT = 1
DECLARE @endLoop2ID INT = 1000 -- Rows you want to add

WHILE @startLoop2ID <= @endLoop2ID
BEGIN
SET @startLoop2ID = @startLoop2ID + 1;



DECLARE @WyposazenieId int
DECLARE @Random@WyposazenieId INT;
DECLARE @Upper@WyposazenieId  INT;
DECLARE @Lower@WyposazenieId   INT

DECLARE @ZamowinieId INT;
DECLARE @Random@ZamowinieId INT;
DECLARE @Upper@ZamowinieId  INT;
DECLARE @Lower@ZamowinieId   INT

SET @Lower@WyposazenieId = 4 ---- The lowest random number
SET @Upper@WyposazenieId = 60 ---- The highest random number
...
EXEC DodajSzczegolyZam @ZamowinieId,@WyposazenieId
